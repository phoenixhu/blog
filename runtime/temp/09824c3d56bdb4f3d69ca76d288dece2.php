<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"C:\wamp64\www\tp5\public/../application/admin\view\article\edit.htm";i:1506496446;s:65:"C:\wamp64\www\tp5\public/../application/admin\view\common\top.htm";i:1506531326;s:66:"C:\wamp64\www\tp5\public/../application/admin\view\common\left.htm";i:1506496446;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="" enctype="multipart/form-data" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <textarea class="form-control" id="desc" name="desc"><?php echo $article['desc']; ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="cateid">
                                                    ...
                                                    <option <?php if($vo['id'] == $article['cateid']): ?> selected="selected" <?php endif; ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <label>
                                                    <input <?php if($article['state'] == 1): ?> checked="checked"<?php endif; ?> class="checkbox-slider colored-darkorange" name="state" type="checkbox">
